...
<div id="metadata_window" class="gs_simpleblog_ui_filter-box"<?php if (isset($_GET['search']) && isset($_GET['filter'])) {echo 'style="display:block !important;"'; } ?>>
    ...
    <form class="largeform" action="load.php" method="get">
        ...
        <input class="text" type="text" name="search" value="<?php if (isset($_GET['search'])) {echo var_out($_GET['search']);} ?>" />
            ...
            else
            {
                foreach ( $posts as $post_slug ) {
                    ...
                    <tr>
                        ...
                        <td class="delete">
                            <a class="delconfirm" href="load.php?id=<?php echo SBLOG; ?>&delete=<?php echo $post_slug; ?>&nonce=<?php echo get_nonce(SBLOG."deletepost"); ?>" title="Delete: <?php echo $post['title']; ?>" >
